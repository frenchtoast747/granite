...
# -*- coding: utf-8 -*-
#
# Granite documentation build configuration file
#
...
extensions = [
    ...
    # Allows for Google-Style Docstrings
    u'sphinx.ext.napoleon',
    # Auto documentation of ArgumentParsers
    u'sphinxarg.ext',
]
...
# Allow for .md files to be used as source files
source_parsers = {
    u'.md': CommonMarkParser,
}
...
project = u'Granite'
author = u'Aaron Boman'
copyright = u'2018 Aaron Boman'

# where to look when trying to link against Python's documentation.
...
man_pages = [
    (master_doc, u'granite',
     u'granite Documentation',
     [], 1)
]
